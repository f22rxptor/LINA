...
def predict():
    try:
        ...
        features = np.array([[age, bmi, bp_systolic, fasting_glucose, family_history, activity_level]])
        ...
        feature_names = ['Age', 'BMI', 'Blood Pressure', 'Fasting Glucose', 'Family History', 'Activity Level']
